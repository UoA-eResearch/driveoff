...
<template>
    ...
    <p>You can request an archive copy of your research drive. See <a target="_blank" href="https://research-hub.auckland.ac.nz">ResearchHub</a> for more information.</p>
</template>
