    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td>Ramya Jayaprakash, Kalita Prangnell, Nick Young</td>
                <td><a href="#" class="btn-link">Change</a></td>
            </tr>
            <tr>
                <td>Department</td>
