...
class TestVerifyUploadedPartSize:
    def test_returns_true_when_sizes_match(self) -> None:
        ...
        assert (
            verify_uploaded_part_size(client, "bucket", "key/part-00001", 512) is True
        )
        client.head_object.assert_called_once_with(
            Bucket="bucket", Key="key/part-00001"
        )
    ...
    def test_returns_false_when_sizes_differ(self) -> None:
        ...
        assert (
            verify_uploaded_part_size(client, "bucket", "key/part-00001", 512) is False
        )
